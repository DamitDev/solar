...
ALTER TABLE hosts ADD COLUMN IF NOT EXISTS roles JSONB DEFAULT '[]';
ALTER TABLE hosts ADD COLUMN IF NOT EXISTS disk_total_gb DOUBLE PRECISION;
ALTER TABLE hosts ADD COLUMN IF NOT EXISTS disk_used_gb DOUBLE PRECISION;
ALTER TABLE hosts ADD COLUMN IF NOT EXISTS disk_available_gb DOUBLE PRECISION;
ALTER TABLE hosts ADD COLUMN IF NOT EXISTS memory_available_gb DOUBLE PRECISION;
"""
