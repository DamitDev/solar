...
The `/mnt/nvme/AI/damit-aiops/solar/training-platform-project/docs/specs/job-step-workspace.md` defines the exact bind-mount contract this module must support:
