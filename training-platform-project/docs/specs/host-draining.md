...
|----------|--------|-----------|
| Managed replica **running** on a draining host | `evacuate` — migrate to the best remaining placement candidate via S-037 | Preserves the replica; the alias keeps serving from the target. |
